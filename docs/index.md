...
2. [System design process](method/system-design-process.md) - learn the repeatable
   path from problem statement to architecture.
3. [Requirement discovery](method/requirement-discovery.md) - practice turning
   vague prompts into functional and non-functional requirements.
4. [Requirements map](requirements/) - choose the requirement category most
   likely to change the design.
5. [Component selection map](components/) - connect requirements to justified
   components.
6. [Walkthroughs](walkthroughs/) or [labs](labs/) - apply the method to worked
...
| --- | --- | --- |
| [Start Here](start-here/) | [Project guardrails](start-here/project-guardrails.md), [definition of done](start-here/definition-of-done.md) | What is in scope, what quality means, and how to contribute safely |
...
| [Visuals](visuals/) | [Diagram style guide](visuals/diagram-style-guide.md), [diagram legend](visuals/diagram-legend.md), [Mermaid examples](visuals/mermaid-examples.md) | How should diagrams clarify decisions instead of decorating pages? |
